...
(defcustom smart-compile-alist '(
  ...
  ;("\\.c\\'"          . "gcc -O2 -g -DLINUX -ansi -I../include -Wall -D_GNU_SOURCE   -L../lib -lpthread %f ../lib/libapue.a -o %n")
  ;("\\.c\\'"          . "gcc -O2 -g -DLINUX -ansi -I../include -Wall -D_GNU_SOURCE   -L../lib -lpthread %f ../lib/libunp.a -o %n")
  ("\\.c\\'"          . "gcc -O2 -g  -ansi -Wall %f -lm -o %n && ./%n")
  ("\\.[Cc]+[Pp]*\\'" . "g++ -O2 -g -Wall %f -lm -o %n")
